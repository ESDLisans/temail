...
<div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
    ...
    <div class="mb-8">
        <div class="flex items-center space-x-3">
            ...
            <div>
                <h1 class="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">Create Page</h1>
                <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Add a new page to your website</p>
            </div>
        </div>
    </div>
            ...
            <form action="{{ route('admin.pages.store') }}" method="POST">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input id="category" name="category" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent dark:bg-gray-700 dark:text-white" type="text" value="{{ old('category') }}" placeholder="e.g., Support Center, Premium Features, etc." />
                    ...
                    <div>
                        ...
                        <input id="subtitle" name="subtitle" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent dark:bg-gray-700 dark:text-white" type="text" value="{{ old('subtitle') }}" placeholder="A brief description that appears under the title" />
                    ...
                    <div>
                        ...
                        <input id="slug" name="slug" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent dark:bg-gray-700 dark:text-white" type="text" value="{{ old('slug') }}" placeholder="Leave empty to generate automatically" />
                    ...
                    <div class="flex items-center">
                        ...
                        <input type="checkbox" name="is_active" class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded" value="1" {{ old('is_active', 1) ? 'checked' : '' }} />
