...
@section('content')
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-semibold text-gray-900">Edit Page: {{ $page->title }}</h1>
        <div class="flex space-x-2">
            <a href="{{ url('/' . $page->slug) }}" target="_blank" class="px-4 py-2 bg-green-600 text-white text-sm font-medium rounded-md hover:bg-green-700">
                View Page
            </a>
